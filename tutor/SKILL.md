...
description: >
  ...
  or says things like "quiz me", "test me", "let's study", "/tutor", "tutor", "study", "review".
---
...
- **New concept**: Add row to table + if wrong, add error note under `### Error Notes` (or localized equivalent)
